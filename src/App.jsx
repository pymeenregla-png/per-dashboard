...
const AGENTES=[
  ...
  {id:"A2",nombre:"Marcas INAPI",      estado:"warn",casos_hoy:6, escalados:2,conf_prom:0.58,canal:"Web",         color:DS.purple},
  {id:"A3",nombre:"Contratos",         estado:"ok",  casos_hoy:3, escalados:0,conf_prom:0.82,canal:"Web",         color:DS.slate},
  {id:"A4",nombre:"Tributario SII",    estado:"ok",  casos_hoy:5, escalados:0,conf_prom:0.88,canal:"Web/WA",      color:DS.green},
  {id:"A5",nombre:"Laboral DT",        estado:"err", casos_hoy:2, escalados:1,conf_prom:0.41,canal:"Instagram/WA",color:DS.amber},
...
const PLAZOS_INIT=[
  ...
  {id:"PL-003",tipo:"SII F29",    cliente:"Panadería Don Lucho E.I.R.L.", asunto:"Formulario 29 — junio 2024",            fecha:"2024-06-12",diasRestantes:10,urgencia:"media",  ref:"PER-2024-0038",gestionado:false},
  {id:"PL-004",tipo:"Laboral LRE",cliente:"Clínica VetSur SpA",           asunto:"Libro de Remuneraciones Electrónico",   fecha:"2024-06-15",diasRestantes:13,urgencia:"media",  ref:"PER-2024-0039",gestionado:false},
...
const CASOS_INIT=[
  {id:"PER-2024-0041",folio:"0041",cliente:"Constructora Austral Ltda.",rut:"76.543.210-K",
   ...
   area:"Marcas",agente:"A2",estado:"HITL",kit:"Arranque",prioridad:"ALTA",confianza:0.52,canal:"Web",
   sla:24,horasTranscurridas:3,etapa:2,asunto:"Solicitud registro marca AUSTRAL BUILDS — clase 37",
   ingreso:"2024-06-01T09:14:00",plazoCritico:"2024-06-05",plazoCriticoGestionado:false,
   fuentesRAG:["Ley 19.039 art. 20","Guía INAPI Clases Niza 2023","Template mandato INAPI v3"],
   resumenIA:"El cliente solicita registro de marca denominativa AUSTRAL BUILDS en clase 37. RAG identifica antecedente similar 'AUSTRAL BUILD' clase 37. Riesgo de confundibilidad fonética. Se recomienda búsqueda fonética en INAPI antes de emitir opinión al cliente.",
   acciones:["Búsqueda fonética INAPI pendiente","Plazo oposición: 30 días hábiles desde publicación DO","Evaluar riesgo confundibilidad con titular anterior"],
   docs:[{nombre:"Análisis_RAG_Marcas_0041.pdf",tipo:"ia",size:"48 KB"}],
   historial:[
     {ts:"2024-06-01T09:14:00",actor:"Sistema",  tipo:"sistema",msg:"Caso ingresado vía formulario web. Correo de confirmación enviado con N° PER-2024-0041."},
     {ts:"2024-06-01T09:15:00",actor:"Agente A2",tipo:"ia",    msg:"RAG completado (3 fuentes). Confianza 52%. Antecedente de confundibilidad detectado. Caso derivado a HITL."},
   ],leccion:""},
  {id:"PER-2024-0040",folio:"0040",cliente:"Sebastián Morales Rivera",rut:"15.234.567-8",
   contacto:{nombre:"Sebastián Morales",email:"smorales@gmail.com",tel:"+56 9 7654 3210"},
   area:"Societario",agente:"A1",estado:"EN_REVISION",kit:"Arranque",prioridad:"MEDIA",confianza:0.78,canal:"WhatsApp",
   sla:48,horasTranscurridas:18,etapa:3,asunto:"Transformación EIRL a SpA — incorporación nuevo socio",
   ingreso:"2024-05-31T16:30:00",plazoCritico:null,plazoCriticoGestionado:false,
   fuentesRAG:["Ley 20.659 art. 5","Manual SpA emprendesimple.cl","Template escritura transformación v2"],
   resumenIA:"Consulta sobre transformación de EIRL a SpA bajo Ley 20.659. Requiere escritura de transformación, nómina de socios y estatutos actualizados. RAG generó checklist de 7 pasos con alta confianza.",
   acciones:["Agendar reunión Teams con cliente 03/06","Preparar escritura transformación","Validar datos nuevo socio (RUT, domicilio)"],
   docs:[{nombre:"Checklist_Transformacion_SpA_0040.pdf",tipo:"ia",size:"32 KB"},{nombre:"Draft_Escritura_v1.docx",tipo:"abogado",size:"85 KB"}],
   historial:[
     {ts:"2024-05-31T16:30:00",actor:"Sistema",  tipo:"sistema",msg:"Caso ingresado vía WhatsApp. N° seguimiento PER-2024-0040 enviado por correo."},
     {ts:"2024-05-31T16:31:00",actor:"Agente A1",tipo:"ia",    msg:"Clasificado: Societario. Checklist 7 pasos generado. Confianza 78%."},
     {ts:"2024-06-01T08:00:00",actor:"Abogado",  tipo:"abogado",msg:"Caso tomado. Draft escritura en preparación. Reunión Teams agendada 03/06 11:00."},
   ],leccion:""},
  {id:"PER-2024-0039",folio:"0039",cliente:"Clínica VetSur SpA",rut:"77.123.456-2",
   contacto:{nombre:"Andrea Campos",email:"admin@vetsur.cl",tel:"+56 9 6543 2109"},
   area:"Laboral",agente:"A5",estado:"ESCALADO",kit:"Intermedio",prioridad:"CRITICA",confianza:0.31,canal:"Instagram DM",
   sla:12,horasTranscurridas:20,etapa:2,asunto:"Término contrato trabajadora con fuero maternal activo",
   ingreso:"2024-05-30T11:20:00",plazoCritico:"2024-06-05",plazoCriticoGestionado:false,
   fuentesRAG:["Código del Trabajo art. 174","Ley 21.327 LRE","Jurisprudencia DT 2023 fuero maternal"],
   resumenIA:"Cliente reporta término de contrato de trabajadora. RAG detecta indicios de fuero maternal activo sin desafuero judicial previo. Riesgo de tutela laboral y nulidad del despido bajo art. 174 CT. Confianza muy baja (0.31). Escalado urgente.",
   acciones:["URGENTE: Verificar estado fuero DT antes de cualquier acción","Preparar carta retractación si aplica","Asesorar en presentación ante Inspección del Trabajo"],
   docs:[{nombre:"Alerta_Fuero_Maternal_0039.pdf",tipo:"ia",size:"28 KB"}],
   historial:[
     {ts:"2024-05-30T11:20:00",actor:"Sistema",  tipo:"sistema",msg:"Caso ingresado vía Instagram DM. N° PER-2024-0039 enviado al cliente."},
     {ts:"2024-05-30T11:22:00",actor:"Agente A5",tipo:"ia",    msg:"ALERTA CRÍTICA: Confianza 31%. Fuero maternal detectado sin desafuero. Escalado urgente a Slack #laboral."},
     {ts:"2024-05-30T12:00:00",actor:"Sistema",  tipo:"sistema",msg:"Notificación enviada a Slack #laboral. SLA: 12h. Tiempo transcurrido: 20h — VENCIDO."},
   ],leccion:""},
  {id:"PER-2024-0038",folio:"0038",cliente:"Panadería Don Lucho E.I.R.L.",rut:"14.876.543-1",
   contacto:{nombre:"Luis Herrera",email:"donlucho@gmail.com",tel:"+56 9 5432 1098"},
   area:"Tributario",agente:"A4",estado:"CERRADO",kit:"Arranque",prioridad:"MEDIA",confianza:0.87,canal:"Web",
   sla:48,horasTranscurridas:28,etapa:6,asunto:"Condonación multa SII — omisión F29 marzo 2024",
   ingreso:"2024-05-28T10:00:00",plazoCritico:null,plazoCriticoGestionado:false,
   fuentesRAG:["Código Tributario art. 192","Circular SII N°8 2022","Template carta condonación v1"],
   resumenIA:"Multa SII por F29 fuera de plazo. Art. 192 CT confirma procedimiento de condonación. Carta generada, revisada y enviada con éxito.",
   acciones:[],
   docs:[{nombre:"Carta_Condonacion_SII_0038.pdf",tipo:"abogado",size:"62 KB"},{nombre:"Comprobante_Envio_0038.pdf",tipo:"sistema",size:"14 KB"}],
   historial:[
     {ts:"2024-05-28T10:00:00",actor:"Sistema",  tipo:"sistema",msg:"Caso ingresado vía web."},
     {ts:"2024-05-28T10:01:00",actor:"Agente A4",tipo:"ia",    msg:"Confianza 87%. Art. 192 CT aplicado. Carta generada."},
     {ts:"2024-05-28T11:00:00",actor:"Abogado",  tipo:"abogado",msg:"Carta revisada y enviada al cliente."},
     {ts:"2024-05-29T14:30:00",actor:"Abogado",  tipo:"abogado",msg:"Cliente confirma recepción. Caso cerrado."},
   ],leccion:"Condonación art. 192 aplicable incluso en segunda omisión si no hay reincidencia dentro de 3 años."},
  {id:"PER-2024-0037",folio:"0037",cliente:"Tech Solutions Valdivia SpA",rut:"76.987.654-3",
   contacto:{nombre:"Valentina García",email:"legal@techsolutionsvaldivia.cl",tel:"+56 9 4321 0987"},
   area:"Contratos",agente:"A3",estado:"EN_REVISION",kit:"Intermedio",prioridad:"ALTA",confianza:0.73,canal:"Web",
   sla:48,horasTranscurridas:42,etapa:4,asunto:"Contrato desarrollo software + NDA con cliente español",
   ingreso:"2024-05-27T15:45:00",plazoCritico:"2024-06-10",plazoCriticoGestionado:false,
   fuentesRAG:["Ley 19.628 datos personales","Template contrato desarrollo software v5","Template NDA internacional v2"],
   resumenIA:"Contrato desarrollo software con empresa española. Borrador generado con cláusulas PI, limitación responsabilidad y NDA. Revisar jurisdicción y moneda.",
   acciones:["Revisar cláusula jurisdicción (Chile vs. España)","Confirmar moneda contrato (CLP/USD/EUR)","Validar compatibilidad firma electrónica avanzada"],
   docs:[{nombre:"Draft_Contrato_Dev_Software_0037.docx",tipo:"ia",size:"120 KB"},{nombre:"NDA_Draft_0037.docx",tipo:"ia",size:"45 KB"}],
   historial:[
     {ts:"2024-05-27T15:45:00",actor:"Sistema",  tipo:"sistema",msg:"Caso ingresado. N° PER-2024-0037 enviado."},
     {ts:"2024-05-27T15:46:00",actor:"Agente A3",tipo:"ia",    msg:"Borrador contrato + NDA generados. Confianza 73%."},
...
const CLIENTES=[
  ...
  {rut:"77.123.456-2",nombre:"Clínica VetSur SpA",           tipo:"SpA",    kit:"Intermedio", suscripcion:true, casos:[2],nps:7,   ingreso:"2024-05-30"},
...
function ConfBar({val,compact=false}){const pct=Math.round(val*100);const color=pct>=70?DS.green:pct>=55?DS.amber:DS.red;return(<div style={{display:"flex",alignItems:"center",gap:8}}>{!compact&&<span style={{fontFamily:"'Outfit',sans-serif",fontSize:10,color:DS.slateL,width:58}}>Confianza</span>}<Bar pct={pct} color={color}/><span style={{fontFamily:"'Outfit',sans-serif",fontSize:11,fontWeight:700,color,minWidth:28}}>{pct}%</span></div>);}
...
function Sidebar({nav,setNav,urgentes}){
  const items=[{id:"casos",icon:"ti-inbox",label:"Casos"},{id:"plazos",icon:"ti-calendar-event",label:"Agenda legal"},{id:"clientes",icon:"ti-building-store",label:"Clientes"},{id:"metricas",icon:"ti-chart-line",label:"Métricas"},{id:"sistema",icon:"ti-cpu",label:"Sistema IA"},{id:"rag",icon:"ti-database",label:"RAG / Fuentes"},{id:"config",icon:"ti-settings",label:"Configuración"}];
  return(<div style={{width:212,background:DS.cream,borderRight:`1px solid ${DS.creamD}`,display:"flex",flexDirection:"column",flexShrink:0,height:"100vh",overflow:"hidden"}}>
    ...
    <div style={{padding:"10px 18px",borderTop:`1px solid ${DS.creamD}`,display:"flex",alignItems:"center",gap:6}}>
      ...
      <span style={{fontFamily:"'Outfit',sans-serif",fontSize:10,color:DS.slate}}>RAG activo · {KPIS.ragChunks.toLocaleString("es-CL")} chunks</span>
    </div>
...
function TopBar({nav}){
  ...
  return(<div style={{height:52,background:DS.white,borderBottom:`1px solid ${DS.creamD}`,display:"flex",alignItems:"center",padding:"0 24px",justifyContent:"space-between",flexShrink:0}}>
    ...
    <div style={{display:"flex",alignItems:"center",gap:20}}>
      {[{label:"Activos",val:KPIS.casosActivos,color:DS.blue},{label:"HITL",val:KPIS.hitlPendientes,color:DS.amber},{label:"SLA",val:`${KPIS.slaRate}%`,color:DS.green}].map(({label,val,color})=>(
        <div key={label} style={{textAlign:"center"}}><div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:18,fontWeight:700,color,lineHeight:1}}>{val}</div><div style={{fontFamily:"'Outfit',sans-serif",fontSize:8,color:DS.slateL,letterSpacing:"0.08em",textTransform:"uppercase"}}>{label}</div></div>
      ))}
      <div style={{display:"flex",alignItems:"center",gap:5,padding:"5px 10px",background:DS.greenL,borderRadius:6}}><div style={{width:6,height:6,borderRadius:"50%",background:DS.green}}/><span style={{fontFamily:"'Outfit',sans-serif",fontSize:10,fontWeight:600,color:DS.green}}>RAG</span></div>
      <div style={{display:"flex",alignItems:"center",gap:5,padding:"5px 10px",background:DS.blueL,borderRadius:6}}><div style={{width:6,height:6,borderRadius:"50%",background:DS.blue}}/><span style={{fontFamily:"'Outfit',sans-serif",fontSize:10,fontWeight:600,color:DS.blue}}>n8n</span></div>
    </div>
  </div>);
}
  ...
  return(<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",zIndex:8888,display:"flex",alignItems:"center",justifyContent:"center"}}>
    <div style={{background:DS.white,borderRadius:12,width:480,maxHeight:"90vh",overflow:"auto",boxShadow:"0 20px 60px rgba(0,0,0,0.3)"}}>
      ...
      <div style={{padding:"16px 24px",borderTop:`1px solid ${DS.creamD}`,display:"flex",gap:8,justifyContent:"flex-end"}}>
        ...
        <button onClick={()=>onSave(form)} style={{padding:"9px 18px",borderRadius:7,border:"none",background:DS.ink,cursor:"pointer",fontFamily:"'Outfit',sans-serif",fontSize:13,fontWeight:600,color:DS.gold}}>Guardar cambios</button>
      </div>
    </div>
  </div>);
}
  ...
  return(<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",zIndex:8888,display:"flex",alignItems:"center",justifyContent:"center"}}>
    <div style={{background:DS.white,borderRadius:12,width:420,boxShadow:"0 20px 60px rgba(0,0,0,0.3)"}}>
      ...
      <div style={{padding:"20px 24px"}}>
        <p style={{fontFamily:"'Outfit',sans-serif",fontSize:13,color:DS.slate,margin:"0 0 16px",lineHeight:1.6}}>Esta acción es <strong>irreversible</strong>. El caso <strong>{caso.id}</strong> de <strong>{caso.cliente}</strong> será eliminado permanentemente.</p>
      ...
      <div style={{padding:"16px 24px",borderTop:`1px solid ${DS.creamD}`,display:"flex",gap:8,justifyContent:"flex-end"}}>
        <button onClick={onClose} style={{padding:"9px 18px",borderRadius:7,border:`1px solid ${DS.creamDD}`,background:"transparent",cursor:"pointer",fontFamily:"'Outfit',sans-serif",fontSize:13,color:DS.slate}}>Cancelar</button>
        <button onClick={()=>confirm===caso.id&&onConfirm()} disabled={confirm!==caso.id} style={{padding:"9px 18px",borderRadius:7,border:"none",background:confirm===caso.id?DS.red:"#ccc",cursor:confirm===caso.id?"pointer":"not-allowed",fontFamily:"'Outfit',sans-serif",fontSize:13,fontWeight:600,color:"#fff"}}>Eliminar</button>
      </div>
    </div>
  </div>);
}
